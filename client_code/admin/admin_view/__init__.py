...
# Set the initial mode to view
    ...
    def button_2_click(self, **event_args):
        ...
        if account and account['e_money'] is not None and account['e_money'] > 0:
        ...
        if account and (
            account['money_usd'] is not None and account['money_usd'] > 0 or
            account['money_inr'] is not None and account['money_inr'] > 0 or
            account['money_euro'] is not None and account['money_euro'] > 0 or
            account['money_swis'] is not None and account['money_swis'] > 0
        ):
